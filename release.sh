...
function commit_and_push {
   ...
   if prompt_yes_no "${green_color}Do you want to commit Legisinc $FINAL_VERSION release locally?${reset_color}"; then
   ...
   if prompt_yes_no "${green_color}Do you want to publish Legisinc $FINAL_VERSION release on Github?${reset_color}"; then
